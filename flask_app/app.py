...
from database.db import get_regiones, get_comunas_by_region, insert_aviso, insert_contacto, insert_foto, get_last_avisos, get_total_avisos, get_avisos_paginated, get_aviso_by_id, get_fotos_by_aviso, get_contactos_by_aviso, get_stats_por_tipo, get_stats_por_dia, get_stats_por_mes
